...
if (isset($_POST['update_button'])) {
    ...
    $updated_gender = $_POST['user_gender'];
    $profile_pic = $user_data['user_pic']; // Default to existing profile pic
    ...
    <div class="profile-container">
        ...
        <div class="profile-pic-container">
            <label for="profile-pic" class="profile-pic-label">
                <img id="profile-pic-preview" src="<?php echo htmlspecialchars($user_data['user_pic']) ?: 'default-profile-pic.jpg'; ?>" alt="Profile Picture" />
            </label>
            ...
            <div class="profile-form">
                ...
                <div class="form-group">
                    ...
                    <select id="city" name="city" required>
                        ...
                        <option value="Mulund" <?php if ($user_data['city'] == 'Mulund') echo 'selected'; ?>>Mulund</option>
                        <option value="Bhandup" <?php if ($user_data['city'] == 'Bhandup') echo 'selected'; ?>>Bhandup</option>
                        <option value="Ghatkopar" <?php if ($user_data['city'] == 'Ghatkopar') echo 'selected'; ?>>Ghatkopar</option>
                ...
                <div class="form-group">
                    ...
                    <select id="foodpref" name="foodpref" required>
                        ...
                        <option value="Rajasthani" <?php if ($user_data['foodpref'] == 'Rajasthani') echo 'selected'; ?>>Rajasthani</option>
                        <option value="Gujarati" <?php if ($user_data['foodpref'] == 'Gujarati') echo 'selected'; ?>>Gujarati</option>
                        <option value="Punjabi" <?php if ($user_data['foodpref'] == 'Punjabi') echo 'selected'; ?>>Punjabi</option>
                        <option value="Maharashtrian" <?php if ($user_data['foodpref'] == 'Maharashtrian') echo 'selected'; ?>>Maharashtrian</option>
                ...
                <button id="profile-update-button" type="submit" class="btn" name="update_button">Update Profile</button>
            </div>
        </form>
    </div>
